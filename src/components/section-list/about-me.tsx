    ...
    return (
        <div className="list-vertical">
            ...
            <div className="list-horizontal">
                <ButtonLinkRounded linkPath={process.env.REACT_APP_GITHUB_PROFILE_URL as string} target={"_blank"}
                                   buttonText="Github"/>
                <ButtonLinkRounded linkPath={DocumentCV} target={"_blank"} buttonText="CV"/>
                <ButtonLinkRounded linkPath={process.env.REACT_APP_LINKEDIN_PROFILE_URL as string} target={"_blank"}
                                   buttonText="Linkedin"/>
            </div>
        </div>
    );
